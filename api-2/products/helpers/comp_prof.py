...
def comp_prof(mdw_1, mdw_2, lang):
    ...
    if mdw_1['rocCompanyInfo']['localforeignCompany'] == 'L' or mdw_1['rocCompanyInfo']['localforeignCompany'] == 'F':
    ...
    if mdw_1['rocCompanyInfo']['localforeignCompany'] == 'L' or mdw_1['rocCompanyInfo']['localforeignCompany'] == 'F' and len(balance_sheet_list) > 0:
        ...
        if mdw_1['rocCompanyInfo']['localforeignCompany'] == 'F':
            bs_data['headOfficeAccount'] = bss_['headOfficeAccount']
    else:
        bs_data = {
            'auditor_name': None,
    ...
    if 'registrationDate' in company_info:
