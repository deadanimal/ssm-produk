...
@Component({
  selector: 'app-product-search-result-package1',
  templateUrl: './product-search-result-package1.component.html',
  styleUrls: ['./product-search-result-package1.component.scss']
})
export class ProductSearchResultPackage1Component implements OnInit {
