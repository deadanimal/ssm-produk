...
@Component({
  selector: "app-search-customize-data",
  templateUrl: "./search-customize-data.component.html",
  styleUrls: ["./search-customize-data.component.scss"],
})
export class SearchCustomizeDataComponent implements OnInit {
